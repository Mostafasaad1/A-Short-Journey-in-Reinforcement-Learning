...
plt.tight_layout()
plt.savefig('pytorch_rl_tutorial/chapter_05_tabular_results.png', dpi=150, bbox_inches='tight')
print("Results saved to chapter_05_tabular_results.png")
